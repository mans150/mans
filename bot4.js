...
if (message.content === '!support') {
      message.author.send(' |https://discord.gg/QEXgvw| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '!inv') {
      message.author.send(' رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=553282332484960279&permissions=8&scope=bot  ').catch(e => console.log(e.stack));
